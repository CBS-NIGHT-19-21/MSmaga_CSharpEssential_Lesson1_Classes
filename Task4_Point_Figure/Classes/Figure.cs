...
{   // State fields of the Figure object.
    ...
    public Point Point3 { get { return _point3!; } set { _point3 = value; } }
    public Point Point4 { get { return _point4!; } set { _point4 = value; } }
    public Point Point5 { get { return _point5!; } set { _point5 = value; } }
    ...
    public double CalcPerimeter(Point point1, Point point2, Point point3)
    {
        //Check conditions into a bool variable
        ...
        if (isWholeness)
        {
            return GetLengthSide(_point1!, _point2!) + GetLengthSide(_point2!, _point3!) +
                   GetLengthSide(_point3!, _point1!);
        }
    ...
    public double CalcPerimeter(Point point1, Point point2, Point point3, Point point4)
    {
        //Check conditions into a bool variable
        bool isWholeness = (point1 != null) && (point2 != null) && (point3 != null) && (point4 != null);

        if (isWholeness)
        {
            return GetLengthSide(_point1!, _point2!) + GetLengthSide(_point2!, _point3!) +
                   GetLengthSide(_point3!, _point4!) + GetLengthSide(_point4!, _point1!);
        }
        else return 0;
    }
    ...
    public double CalcPerimeter(Point point1, Point point2, Point point3, Point point4, Point point5)
    {
        bool isWholeness = (point1 != null) && (point2 != null) && (point3 != null) && (point4 != null)
                            && (point5 != null);
        ...
        {
            return GetLengthSide(_point1!, _point2!) + GetLengthSide(_point2!, _point3!) +
                   GetLengthSide(_point3!, _point4!) + GetLengthSide(_point4!, _point5!) +
